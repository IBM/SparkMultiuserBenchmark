...
$SPARK_HOME/bin/spark-submit --master spark://red21:7078 --deploy-mode client --class com.ibm.platform.benchmarks.smb2.analysis.SMB2Analysis /perf_test/perf_harness_2/SMB2Analysis.jar /perf_test/perf_data_2/$DATEFORNMON
