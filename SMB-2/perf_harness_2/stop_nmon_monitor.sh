...
do
    ...
    sshpass -p LSFa4Sum ssh -o StrictHostKeyChecking=no root@$LINE "sudo killall -9 nmon"
    sshpass -p LSFa4Sum scp -o StrictHostKeyChecking=no root@$LINE:/tmp/node${LINE}_$Date.nmon /tmp/nmon_$Date
