...
while [ $COUNTER -lt $NUM_STREAMS ]; do
    ...
    ./single_stream_async-batch.sh $NUM_SEQ_ITER $QUERY_DELAY $SEQ_DELAY $COUNTER $TPCDS_DB_PATH > /perf_test/perf_data_2/driver_output_${COUNTER}.log 2>&1 &
...
TOTAL_LINES=$(($NUM_STREAMS * $NUM_SEQ_ITER * 5))
